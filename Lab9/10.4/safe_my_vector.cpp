...
void print_my_vector_status(const my_vector& v) {
    if (!looks_consistent_my_vector(v))
        throw (string)"print_my_vector_status: Il vettore non è consistente";
...
void push_back_my_vector_element(my_vector& v, double x) {
    if (!looks_consistent_my_vector(v))
        throw (string)"push_back_my_vector_element: Il vettore non è consistente";
...
double pop_back_my_vector_element(my_vector& v) {
    if (!looks_consistent_my_vector(v))
        throw (string)"pop_back_my_vector_element: Il vettore non è consistente";
    if (v.size == 0)
...
void resize_my_vector(my_vector& v, unsigned int new_capacity) {
    if (!looks_consistent_my_vector(v))
        throw (string)"resize_my_vector: Il vettore non è consistente";
    if (new_capacity <= 0)
...
void safe_push_back_my_vector_element(my_vector& v, double x) {
    if (!looks_consistent_my_vector(v))
        throw (string)"safe_push_back_my_vector_element: Il vettore non è consistente";
...
void destroy_my_vector(my_vector& v) {
    if (!looks_consistent_my_vector(v))
        throw (string)"destroy_my_vector: Il vettore non è consistente";
...
void sort_my_vector(my_vector& v) {
    if (!looks_consistent_my_vector(v))
        throw (string)"sort_my_vector: Il vettore non è consistente";
